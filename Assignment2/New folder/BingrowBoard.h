...
class BingrowBoard{
   private:
      ...
      /*
      originalSize: Original size of the board.
      currentSize: Current size of the board - changes after expantion.
      rightValues: Right values after the original board. 
      leftValues: Left values after the original board.
      */
